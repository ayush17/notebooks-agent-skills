...
Works on **any branch** (rhoai-2.25, rhoai-3.3, rhoai-3.4, rhoai-3.5, main, etc.)

## Prerequisites

- Jira MCP configured (Atlassian MCP)
...
**Fixed (PRs created):**
• CVE-2026-34986 (tornado) - PR #2550
• CVE-2026-1462 (keras) - PR #2551
[list all]
